 ...
 */
class getReleaseTypeService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Form\ReleaseType' shared autowired service.
     *
     * @return \App\Form\ReleaseType
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/AbstractType.php';
        include_once \dirname(__DIR__, 4).'/src/Form/ReleaseType.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-bundle/Security.php';

        return $container->privates['App\\Form\\ReleaseType'] = new \App\Form\ReleaseType(new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
